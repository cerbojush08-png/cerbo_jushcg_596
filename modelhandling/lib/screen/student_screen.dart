...
class _StudentPageState extends State<StudentPage> {
  ...
  void loadStudents() async {
    ...
    final data = await controller.getStudents();
  ...
  void addStudent() async {
    ...
    final student = Student(
      ...
      quiz: double.parse(quizController.text.trim()),
      activity: double.parse(activityController.text.trim()),
      exam: double.parse(examController.text.trim()),
    );
